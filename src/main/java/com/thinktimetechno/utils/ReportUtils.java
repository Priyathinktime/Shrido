...
//        if (FrameworkConstants.OVERRIDE_REPORTS.trim().equals(FrameworkConstants.NO)) {
//            System.out.println("OVERRIDE_REPORTS = " + FrameworkConstants.OVERRIDE_REPORTS);
//            String latestFolder= FrameworkConstants.EXTENT_REPORT_FOLDER_PATH+File.separator+getLatestFilefromDir(FrameworkConstants.EXTENT_REPORT_FOLDER_PATH );
//
//            System.out.println("folder report: " + latestFolder);
//            link=  latestFolder  + File.separator + File.separator+FrameworkConstants.EXTENT_REPORT_FILE_NAME;
//
//
//            System.out.println("Created link report: " + link);
//            return link;
